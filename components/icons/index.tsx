 ...
 * @param viewBox - SVG viewBox (default is: "0 0 24 24")
 */
const createIcon = (path: string, name: string, viewBox = "0 0 24 24") => {
...
/**
 * Factory function to create icon components with multiple paths
 * @param path - SVG path data
 * @param name - Component display name
 * @param viewBox - SVG viewBox (default is: "0 0 24 24")
 */
const createMultiPathIcon = (
  paths: string[],
  name: string,
  viewBox = "0 0 24 24"
) => {
